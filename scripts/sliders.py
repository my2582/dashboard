...
def combined_probability_tab():
    ...
    # Set up data
    df = pd.read_csv("/Users/msyeom/Google Drive/Machine Learning for Global Risk/TR Corpus/CombinedProbability_Values.csv")
    ...
    tab = Panel(child=layout, title="Combined Probability")
